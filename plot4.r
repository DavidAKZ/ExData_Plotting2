...
## x= 30501023, 30531008, 30531009, 30531010, 30531011, 30531012, 30531014, 30531015, 30531016, 30531017, 30531090, 30531099
## The following SCC values have been omitted due to lack of data points, 30531001, 30531004, 30531006, 30531007

SCC_MergedDf <- subset(mergeDf, mergeDf$SCC=='x')  
